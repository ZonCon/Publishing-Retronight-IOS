...
@interface ContentItemDetailsViewController : UIViewController <NSURLConnectionDelegate, CNContactViewControllerDelegate>

@property (nonatomic, strong) IBOutlet UIScrollView *scView;
@property (nonatomic, strong) UILabel *labelViews;
