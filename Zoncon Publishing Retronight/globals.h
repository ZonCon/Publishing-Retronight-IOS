...
static NSString *SHARE_MSG = @"ZonCon Publishing Retronight App";
static NSString *SHARE_SUBJECT = @"ZonCon Publishing Retronight App";
static NSString *SHARE_CONTENT = @"Thank you for downloading the ZonCon Publishing App!";
static NSString *FEEDBACK_EMAIL_SUBJECT = @"ZonCon Publishing Retronight App Feedback";
